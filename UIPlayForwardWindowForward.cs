...
public class UIPlayForwardWindowForward : MonoBehaviour
{
	static public UIPlayForwardWindowForward current = null;
	...
	void Start ()
	{
		target = this.GetComponentInParent<Animation>();
		clipName = "Window - Forward";
		mStarted = true;
